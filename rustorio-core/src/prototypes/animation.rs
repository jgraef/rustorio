...
/// TODO: This contains a lot of (if not all) fields of `types::Animation`. So we could just put that into here.
...
pub struct Animation {
    ...
    hr_version: Option<types::Animation>,

    /// layers :: table of Animation (optional)
    layers: Option<Vec<types::Animation>>,
    ...
    position: Option<Vec<SpriteSize>>,
